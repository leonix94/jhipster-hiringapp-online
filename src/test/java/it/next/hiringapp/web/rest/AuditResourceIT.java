...
import it.next.hiringapp.config.audit.AuditEventConverter;
import it.next.hiringapp.domain.PersistentAuditEvent;
import it.next.hiringapp.repository.PersistenceAuditEventRepository;

import it.next.hiringapp.service.AuditEventService;
