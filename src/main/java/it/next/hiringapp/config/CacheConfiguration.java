package it.next.hiringapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.next.hiringapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.next.hiringapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
